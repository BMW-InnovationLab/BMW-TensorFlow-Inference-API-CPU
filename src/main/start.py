...
from fastapi import FastAPI, Form, File, UploadFile, Header, BackgroundTasks
...
error_logging = Error()
app = FastAPI(version='3.1.0', title='BMW InnovationLab tensorflow cpu inference Automation',
